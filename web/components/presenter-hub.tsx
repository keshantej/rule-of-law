  ...
  return (
    <main className="px-5 py-8 md:px-8 md:py-10">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-5 max-w-3xl text-lg leading-8 text-paper/86">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-4">
          {tracks.map((track) => (
            <div key={track.minutes} className="rounded-[1.5rem] border border-paper/10 bg-paper p-5 text-ink">
              ...
              <div className="mt-4 rounded-2xl border border-ink/10 bg-white px-4 py-3 text-sm text-ink/70">
                <p className="font-semibold text-ink">{track.steps.length} timed blocks</p>
          ...
          <div className="rounded-[1.5rem] border border-paper/10 bg-paper p-5 text-ink">
          ...
          <div className="space-y-10">
            <section>
              <div className="mb-5 border-t border-paper/10 pt-5">
                ...
                <h2 className="mt-2 text-3xl font-semibold tracking-[-0.04em] text-paper">Timed scripts for 20, 45, and 60 minute sessions.</h2>
              </div>
            ...
            <section>
              <div className="mb-5 border-t border-paper/10 pt-5">
                ...
                <h2 className="mt-2 text-3xl font-semibold tracking-[-0.04em] text-paper">Preparation guidance, difficult questions, and printable support.</h2>
              </div>
              <div className="space-y-5">

...
export function SiteFooter() {
  return (
    <footer className="mt-16 border-t border-white/[0.04] pt-8 pb-6">
      <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-xs text-[11px] leading-4 text-white/15">
            A civic education initiative of the Arizona legal community, promoting nonpartisan understanding of the Rule of Law.
          </p>
        </div>
